...
[source,asciidoc,indent=0,role="secondary"]
----
include::../restdocs-jackson/src/main/resources/org/springframework/restdocs/templates/asciidoctor/section.snippet[]
----
...
| {link}
| items-id
| Derived from the documentation string. For example: `ìtems/id`.
