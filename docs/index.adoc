...
Yes, it is easy to use in existing or new Spring MVC tests.
...
Not yet.
We may add support for REST Assured in the future,
but your PR is also welcome.

[discrete]
=== Is Jackson required for automatic field documentation?

Yes, this project is only includes a Jackson visitor so far.
