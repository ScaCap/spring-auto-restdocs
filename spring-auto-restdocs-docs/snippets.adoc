...
The links usually cannot be determined from the response class, because they are highly dynamic and often just stored in a Map.
...
Test method needs to be configured with documentation type:
