...
link:{core-package}/request/RequestHeaderSnippet.java[Request headers snippet] automatically lists headers their type, whether they are optional, and their Javadoc with constraints.
