...
public class JacksonResponseFieldSnippetTest extends AbstractSnippetTests {
    ...
    @Before
    public void setup() {
        // Jdk8_Jackson_2_12_ObjectMapperAdapter doesn't really matter here as we're using serializer logic
        // which skips WRITE_ONLY fields automatically
        mapper = new Jdk8_Jackson_2_12_ObjectMapperAdapter(new ObjectMapper());
