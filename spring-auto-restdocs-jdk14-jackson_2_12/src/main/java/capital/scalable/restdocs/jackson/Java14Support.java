...
public abstract class Java14Support {
    ...
    private static class Java14ClassIntrospector extends BasicClassIntrospector {
        ...
        protected POJOPropertiesCollector constructPropertyCollector(MapperConfig<?> config, AnnotatedClass classDef, JavaType type, boolean forSerialization, AccessorNamingStrategy accNaming) {
            return new PropertiesCollector(config, forSerialization, type, classDef, accNaming);
        }
    ...
    private static class PropertiesCollector extends POJOPropertiesCollector {
        ...
        public PropertiesCollector(MapperConfig<?> config, boolean forSerialization, JavaType type, AnnotatedClass classDef, AccessorNamingStrategy accNaming) {
