...
public class JacksonResponseFieldSnippetTest extends AbstractSnippetTests {
    ...
    @Before
    public void setup() {
        // Jdk14_Jackson_2_11_ObjectMapperAdapter doesn't really matter here as we're using serializer logic
        // which skips WRITE_ONLY fields automatically
        mapper = new Jdk14_Jackson_2_11_ObjectMapperAdapter(new ObjectMapper());
